...
var currentWSpeed = document.querySelector("#wind-speed");
...
var sCity = [];
    ...
    //USE NEW KEY-DIDN'T WORK- USING DEFAULT KEY
    var APIKey = "30b76af80ad531ee13318e7a022ffa01";
    ...
    $(document).on("load", invokePastSearch);
